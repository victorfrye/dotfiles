...
export PATH=$HOME/bin:/usr/local/bin:~/Projects/homebin:$PATH

# Path to your oh-my-zsh installation.
export ZSH="/Users/vic75240/.oh-my-zsh"
...
alias mcir="mvn clean install -Prun"
alias mcirs="mvn clean install -Prun -DskipTests"
alias mcid="mvn clean install -Pdebug"
alias mcids="mvn clean install -Pdebug -DskipTests"
...
# OpenShift - might be done by Furl as well
alias opb="oc login https://openshift.opb.spectrum-health.org -u=${USER}"
