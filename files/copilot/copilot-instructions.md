...
- **Evidence first:** Gather from diffs/commits, validation output, project docs, durable session/planning state, and conversation history before drafting any findings — name any source that's genuinely unavailable rather than silently skipping it.
